...
Calistirma:
    python -m scripts.data_augmented
"""
...
def augment_dataset(
    ...
    *,
    ...
    processed_doc = {
        "meta": {
            **meta,
            "kaynak": "scripts/data_augmented.py",
    ...
    # Ham dosya yalnizca taban kayitlari tutar; augment sonrasi birlestirilmis
    # raw_merged ile uzerine yazmak gecmiste 928 -> 5674 kayit bozulmasina yol acti.
    # Bu nedenle update_raw kalici olarak kapali — ham dosya elle/verified snapshot ile yonetilir.
    if update_raw:
        print(
            f"\n[!] update_raw=True reddedildi: ham dosya korunuyor ({raw_path}). "
            f"Yazilacak birlestirilmis kayit sayisi={len(raw_merged)} olurdu.",
            file=sys.stderr,
        )
