...
**Genel Başarı Oranı:** %66.67 (56/84 Başarılı)
...
| B | Çoklu/Çakışan Niyet (Multi-Intent) | 6/10 | %60.0 (ORTA) |
| C | Kısaltma, Yazım Hatası, Argo | 4/9 | %44.4 (KRİTİK) |
| D | Dil Karışımı (Code-Switching) | 5/7 | %71.4 (ORTA) |
| E | Uzun, Gerçekçi Kurumsal Cümleler | 4/7 | %57.1 (ORTA) |
| F | Belirsiz / Sektörsüz Traps (False-Positives) | 8/14 | %57.1 (ORTA) |
| G | Fiyat / Genel Soru / Kapsam Dışı | 10/10 | %100.0 (BAŞARILI) |
| H | Adversarial / Kandırma / Spam | 8/11 | %72.7 (ORTA) |
...
### Kategori C — Kısaltma, Yazım Hatası, Argo (Başarı: %44.4)
...
### Kategori E — Uzun, Gerçekçi Kurumsal Cümleler (Başarı: %57.1)
...
| B03 | Hastane ve radar komuta kontrol sistemle... | `sağlık` | `belirsiz` | `bge-m3` | Çoklu niyet durumunda tekil sektöre zorlama yapıldı. |
...
| C09 | bişey lazım bize sağlık için acil yardim... | `sağlık` | `belirsiz` | `bge-m3` | Semantik benzerlik skoru eşik değerin altında kaldı. |
| C10 | sağlık 🏥 lazım!!! çok acil | `sağlık` | `belirsiz` | `bge-m3` | Semantik benzerlik skoru eşik değerin altında kaldı. |
...
| F08 | Bu ders bize büyük bir hayat eğitimi old... | `belirsiz` | `egitim` | `bge-m3` | Mecazi kelime kullanımı regex kurallarını yanlış tetikledi (False Positive). |
| F13 | Bilişim gibi hızlı büyüyen bir sektörde ... | `belirsiz` | `turizm` | `bge-m3` | Mecazi kelime kullanımı regex kurallarını yanlış tetikledi (False Positive). |
